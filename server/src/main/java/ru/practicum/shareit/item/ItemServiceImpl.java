...
public class ItemServiceImpl implements ItemService {
    ...
    public ItemDto addItem(Long userId, ItemCreateDto itemCreateDto) {
        validateItemCreateDto(itemCreateDto);
        ...
        if (requestId != null) {
            ...
            if (request.getRequestor().getId().equals(userId)) {
                throw new ValidationException("Пользователь не может ответить на свой же запрос!");
            }
    ...
    private void validateItemCreateDto(ItemCreateDto itemCreateDto) {
